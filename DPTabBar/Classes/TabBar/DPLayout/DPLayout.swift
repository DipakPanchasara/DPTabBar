...
public extension UIView {
    @discardableResult func alignEdges(_ edges: [DPLayoutEdge], withView view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func alignEdges(_ edges: [DPLayoutEdge], withView view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constants: [CGFloat], priority: UILayoutPriority = .required) -> UIView {
...
public extension UIView {
    @discardableResult func width(_ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat, priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func height(_ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat, priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func height(with edge: DPLayoutEdge, _ constantModifier: DPLayoutConstantModifier = .equalTo, ofView view: UIView, multiplier: CGFloat = 1.0, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func width(with edge: DPLayoutEdge, _ constantModifier: DPLayoutConstantModifier = .equalTo, ofView view: UIView, multiplier: CGFloat = 1.0, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
...
public extension UIView {
    ...
    @discardableResult func alignEdgeWithSuperview(_ edge: DPLayoutEdge, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
        guard let superview = superview else { return self }
        return alignEdge(edge, withView: superview, constantModifier, constant: constant, priority: priority)
    }
    
    @discardableResult func alignEdgeWithSuperviewSafeArea(_ edge: DPLayoutEdge, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
        guard let superview = superview else { return self }
        return pinEdge(edge, toEdge: edge.safeAreaEdge, ofView: superview, constantModifier, constant: constant, priority: priority)
    }
    
    @discardableResult func alignAllEdgesWithSuperview(_ constantModifier: DPLayoutConstantModifier = .equalTo, edgeInsets: UIEdgeInsets = .zero, priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func alignEdgesWithSuperview(_ edges: [DPLayoutEdge], _ constantModifier: DPLayoutConstantModifier = .equalTo, constants: [CGFloat], priority: UILayoutPriority = .required) -> UIView {
        guard let superview = superview else { return self }
        
        return alignEdges(edges, withView: superview, constantModifier, constants: constants, priority: priority)
    }
    
    @discardableResult func alignEdgesWithSuperview(_ edges: [DPLayoutEdge], _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
        guard let superview = superview else { return self }
...
public extension UIView {
    @discardableResult func toLeftOf(_ view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
        return pinEdge(.right, toEdge: .left, ofView: view, constantModifier, constant: constant, priority: priority)
    }
    
    @discardableResult func toRightOf(_ view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
        return pinEdge(.left, toEdge: .right, ofView: view, constant: constant, priority: priority)
    }
    
    @discardableResult func toTopOf(_ view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
        return pinEdge(.bottom, toEdge: .top, ofView: view, constantModifier, constant: constant, priority: priority)
    }
    
    @discardableResult func toBottomOf(_ view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func horizontallyCenterWith(_ view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
        return pinEdge(.centerX, toEdge: .centerX, ofView: view, constantModifier, constant: constant, priority: priority)
    }
    
    @discardableResult func verticallyCenterWith(_ view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
        return pinEdge(.centerY, toEdge: .centerY, ofView: view, constantModifier, constant: constant, priority: priority)
    }
    
    @discardableResult func alignEdge(_ edge: DPLayoutEdge, withView view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required ) -> UIView {
        return pinEdge(edge, toEdge: edge, ofView: view, constantModifier, constant: constant, priority: priority)
    }
    
    @discardableResult func pinEdge(_ edge1: DPLayoutEdge, toEdge edge2: DPLayoutEdge, ofView view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
        
        if edge1.axis != edge2.axis {
            assertionFailure("DPLayout Error: all edges of same constraint must be of same axis")
        }
...
private extension UIView {
    @discardableResult func pinHorizontalEdge(_ edge1: DPLayoutEdge, toEdge edge2: DPLayoutEdge, ofView view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func pinVerticalEdge(_ edge1: DPLayoutEdge, toEdge edge2: DPLayoutEdge, ofView view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func pinDimensionEdge(_ edge1: DPLayoutEdge, toEdge edge2: DPLayoutEdge, ofView view: UIView, _ constantModifier: DPLayoutConstantModifier = .equalTo, mutliplier: CGFloat = 1, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
