...
class FullViewController: DPTabBarController {

    override func viewDidLoad() {
        self.title = "Full Shape TabBar"
        self.setupUI()
        super.viewDidLoad()
    }
    ...
    func setupUI() {
        ...
        vc5.tabBarItem = UITabBarItem(title: "HOME", image: UIImage.imageWithColor(color: UIColor.red, size: CGSize(width: 24, height: 24)), tag: 1)
